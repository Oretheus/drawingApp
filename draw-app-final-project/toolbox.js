...
this.selectTool = function(toolName) {
  ...
  for (var i = 0; i < this.tools.length; i++) {
    if (this.tools[i].name == toolName) {
      ...
      // Ensure the selected tool has required mouse event functions
      if (!this.selectedTool.hasOwnProperty("mousePressed")) {
        this.selectedTool.mousePressed = function() {};
      }
      if (!this.selectedTool.hasOwnProperty("mouseDragged")) {
        this.selectedTool.mouseDragged = function() {};
      }
      if (!this.selectedTool.hasOwnProperty("mouseReleased")) {
        this.selectedTool.mouseReleased = function() {};
      }
